...
debug = 0
alert = "alert.py humidity " + value + " " + name #may require absolute path

if (15 < checkfloat < 85): #acceptable humidity range
	pass
else:
...
filerrd = (name + '.rrd')
outName = str('/var/www/demo/cgi-bin/rrd/humidity/' + filerrd) #may require absolute path
if not os.path.exists(outName):
 rrdtool.create( outName,
 '--start', '-300',
 '--step', '60',
 'DS:temp:GAUGE:1200:0:100',
